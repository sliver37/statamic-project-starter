 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager         
                        /** @var \Statamic\Auth\Passwords\PasswordBrokerManager $instance */
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Archetype\ServiceProvider::bootStrMacros()
         * @param mixed $target
         * @static 
         */ 
        public static function hasOneMethodName($target)
        {
                        return \Illuminate\Support\Str::hasOneMethodName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::hasManyMethodName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::belongsToMethodName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::belongsToManyMethodName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::hasOneDocBlockName($target);
        }
                    /**
         * 
         *
         * @see \Archetype\ServiceProvider::registerFacades()
         * @param mixed $target
         * @static 
         */ 
        public static function hasManyDocBlockName($target)
        {
                        return \Illuminate\Support\Str::hasManyDocBlockName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::belongsToDocBlockName($target);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::belongsToManyDocBlockName($target);
        }
...
namespace  { 
            ...
            class LaravelFile extends \Archetype\Facades\LaravelFile {}
            class PHPFile extends \Archetype\Facades\PHPFile {}
            class Debugbar extends \Barryvdh\Debugbar\Facades\Debugbar {}
            class Flare extends \Facade\Ignition\Facades\Flare {}
            class Action extends \HandmadeWeb\HookableActionsAndFilters\Action {}
            class Filter extends \HandmadeWeb\HookableActionsAndFilters\Filter {}
